...
function App() {
  ...
  const checkCount = (currentTime) => {
    ...
    if (currentTime >= 3.5 && currentTime <= 8.5 && !showImage1 && image1Count < 1) {
    ...
    if (currentTime >= 6 && currentTime <= 8 && !showImage2 && image2Count < 2) {
    ...
    if (currentTime >= 7 && currentTime <= 8.5 && !showImage3 && image3Count < 3) {
